#============================================================
              ...
              if msg.from_ in admin:
                md = "⭐=࿅ོ࿆༼status protect༽࿅ོ࿆=\n*============*\n"
                if wait["Protectgr"] == True: md+="࿅ོ࿆•Protect QR [On]\n"
                else: md+="࿅ོ࿆•Protect QR [Off]\n"
                if wait["Protectcancl"] == True: md+="࿅ོ࿆•Protect Invite [On]\n"
                else: md+="࿅ོ࿆•Protect Invite [Off]\n"
                if wait["contact"] == True: md+="࿅ོ࿆•Contact [On]\n"
                else: md+="࿅ོ࿆•Contact [Off]\n"
                if wait["autoJoin"] == True: md+="࿅ོ࿆•Auto Join [On]\n"
                else: md +="࿅ོ࿆•Auto Join [Off]\n"
                if wait["autoCancel"]["on"] == True:md+="࿅ོ࿆•Group Cancel " + str(wait["autoCancel"]["members"]) + "\n"
                else: md+= "࿅ོ࿆•Group Cancel [Off]\n"
                if wait["leaveRoom"] == True: md+="࿅ོ࿆•Auto Leave [On]\n"
                else: md+="࿅ོ࿆•Auto Leave [Off]\n"
                if wait["timeline"] == True: md+="࿅ོ࿆•Share [On]\n"
                else:md+="࿅ོ࿆•Share [Off]\n"
                if wait["autoAdd"] == True: md+="࿅ོ࿆•Auto Add [On]\n"
                else:md+="࿅ོ࿆•Auto Add [Off]\n"
                if wait["Backup"] == True: md+="࿅ོ࿆•Backup : on\n"
                else:md+="࿅ོ࿆•Backup : off\n"
                if wait["qr"] == True: md+="࿅ོ࿆•AutoBlock QR : on\n"
                else:md+="࿅ོ࿆•AutoBlock QR : off\n"
                if wait["commentOn"] == True: md+="࿅ོ࿆•Comment [On]\n"
                else:md+="࿅ོ࿆•Comment [Off]\n"
                if wait["protectionOn"] == True: md+="࿅ོ࿆•Protection : hight\n"+ datetime.today().strftime('%H:%M:%S')
                else:md+="࿅ོ࿆•Protection : low\n"+ datetime.today().strftime('%H:%M:%S')
                "\n*============*\n=࿅ོ࿆༼U.K-mora_yena༽࿅ོ࿆=\n*============*"
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print "[Command] Check"
                                chiya += rom[1] + "\n"
                        cl.sendText(msg.to, "✔ ✰TEAM BOTS KILLS ✰\nRead : %s\n\n✖ Sider :\n%s\nPoint creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                        except:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                k1.sendText(msg.to,"★★★★Hadir★★★★")
                k2.sendText(msg.to,"★★★★Hadir★★★★")
                k3.sendText(msg.to,"★★★★★Hadir★★★★★")
                k4.sendText(msg.to,"★★★★★Hadir★★★★★")
                k5.sendText(msg.to,"★★★★★★Hadir★★★★★★")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ ByTEAM BOTS KILLS⭐👈 »»» http://line.me/ti/p/boy29putra«««")
                    ...
                    #k3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By⭐👈 »»» http://line.me/ti/p/boy29putra «««")
                    print "Like"
                except:
                    pass
            else:
